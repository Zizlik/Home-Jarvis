...
export const ZONES: Record<string, Zone> = {
  ...
  london: { label: "Londýn", tz: "Europe/London" },
  bst: { label: "Londýn", tz: "Europe/London" },
  cet: { label: "CET", tz: "Europe/Paris" },
  paris: { label: "Paříž", tz: "Europe/Paris" },
  berlin: { label: "Berlín", tz: "Europe/Berlin" },
  amsterdam: { label: "Amsterdam", tz: "Europe/Amsterdam" },
  prague: { label: "Praha", tz: "Europe/Prague" },
  praha: { label: "Praha", tz: "Europe/Prague" },
  brno: { label: "Brno", tz: "Europe/Prague" },
  bratislava: { label: "Bratislava", tz: "Europe/Bratislava" },
  vienna: { label: "Vídeň", tz: "Europe/Vienna" },
  warsaw: { label: "Varšava", tz: "Europe/Warsaw" },
  rome: { label: "Řím", tz: "Europe/Rome" },
  madrid: { label: "Madrid", tz: "Europe/Madrid" },
  barcelona: { label: "Barcelona", tz: "Europe/Madrid" },
  lisbon: { label: "Lisabon", tz: "Europe/Lisbon" },
  athens: { label: "Atény", tz: "Europe/Athens" },
  moscow: { label: "Moskva", tz: "Europe/Moscow" },
  istanbul: { label: "Istanbul", tz: "Europe/Istanbul" },
  bangkok: { label: "Bangkok", tz: "Asia/Bangkok" },
  beijing: { label: "Peking", tz: "Asia/Shanghai" },
  shanghai: { label: "Šanghaj", tz: "Asia/Shanghai" },
  "mexico city": { label: "Mexiko", tz: "America/Mexico_City" },
  ...
  tokyo: { label: "Tokio", tz: "Asia/Tokyo" },
  jst: { label: "Tokio", tz: "Asia/Tokyo" },
...
export function formatIn(tz: string, at: Date) {
  return new Intl.DateTimeFormat("cs-CZ", { timeZone: tz, hour: "numeric", minute: "2-digit" }).format(at);
}
